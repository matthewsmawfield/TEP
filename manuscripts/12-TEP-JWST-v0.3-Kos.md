...
from Cepheid period-luminosity residuals: $\kappa_{\rm gal} = (9.6 \pm 4.0) \times 10^5$ mag. 
...
$$\kappa_{\rm gal} = \frac{|b|\,\eta_{\rm clock}\,k_{\rm virial}}{\ln 10} = (9.6 \pm 4.0) \times 10^5 \text{ mag}$$
...
$$K = \frac{\kappa_{\rm gal} \times \ln(10)}{2.5 \times n} \approx 1.26 \times 10^6$$
...
analysis uses the Paper 11 coupling $\kappa_{\rm gal} = (9.6 \pm 4.0) \times 10^5$ mag 
...
$$K = \frac{\kappa_{\rm gal} \times \ln(10)}{2.5 \times n} \approx 1.26 \times 10^6, \quad \Phi_0 = 1.6\times10^{-7} \times \left(\frac{M_h}{10^{12} M_\odot}\right)^{2/3}$$
...
effective coupling to $\kappa_{\rm gal} \ll \alpha_0$ and yielding
...
| --- | --- | --- | --- |
| $\kappa_{\rm gal}$ (clock-sector) | $(9.6 \pm 4.0) \times 10^5$ mag | Cepheid distance-ladder (Paper 11) | Observable Response Coefficient for galactic environments; absorbs stellar physics, environmental activation, and transfer function (distinct from bare coupling $\beta$) |
| $\beta$ (fundamental) | $\approx 2.3 \times 10^5$ | Derived from $\kappa_{\rm gal}$ via TEP action | Fundamental conformal coupling $\beta$ in $A(\phi) = e^{\beta\phi/M_{\rm Pl}}$ |
| $\kappa_{\rm gal}$ (Paper 11) | $(9.6 \pm 4.0) \times 10^5$ mag | Cepheid period-luminosity residuals | Observable Response Coefficient measured from magnitude residuals; applies directly to potential-linear $\Gamma_t$ formula |
| $\alpha_0$ (legacy) | $0.58$ | Backward compatibility | Legacy dimensionless coupling; maps to $\kappa_{\rm gal}$ via $(\alpha_0/0.58) \times 9.6\times10^5$ |
