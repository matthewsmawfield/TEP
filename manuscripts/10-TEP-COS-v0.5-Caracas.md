...
First published: 9 January 2026 · Last updated: 2026-04-27
...
- Weak-Field Limit: In the non-relativistic limit appropriate for clusters and halos, a linear mapping $\phi \propto \Phi$ is assumed, absorbing coupling constants into the effective enhancement parameter $\kappa_{\text{MSP}}$.
...
| --- | --- | --- | --- |
| TEP | 3 (κ_MSP, ρ_c, σ_screen) | 10.5 | Baseline |
