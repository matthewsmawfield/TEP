...
This paper develops a covariant bi-metric framework where proper time is a dynamical scalar field φ coupled conformally to matter via A(φ) = exp(βφ/M_Pl). The theory preserves local Lorentz invariance while generating path-dependent synchronization holonomy $H_{\rm resid}$ that vanishes in GR but becomes nonzero when time is dynamical. Key predictions include: (1) distance-structured correlations in precision timing networks with λ ~ 1,000–10,000 km, (2) screened local physics via Temporal Topology governed by Temporal Shear $\Sigma_\mu = \nabla_\mu \ln A$, and (3) falsifiable holonomy signatures in next-generation metrology. The disformal sector is constrained by GW170817 (|c_γ − c_g|/c ≲ 10⁻¹⁵), while the conformal sector remains unconstrained—providing a window for TEP phenomenology.
...
|-------|-----------|-------|-----|
| **Paper 0** | **TEP** (This repo) | Temporal Equivalence Principle: Dynamic Time & Emergent Light Speed | [10.5281/zenodo.16921911](https://doi.org/10.5281/zenodo.16921911) |
...
| **Paper 14** | [TEP-GNSS-MGEX](https://github.com/matthewsmawfield/TEP-GNSS-MGEX) | Global Time Echoes IV: Held-Out Replication in the Public MGEX Combined Multi-GNSS Clock Product, 2025–2026 | [10.5281/zenodo.17127229](https://doi.org/10.5281/zenodo.17127229) |
...
| **Paper 18** | [TEP-HC](https://github.com/matthewsmawfield/TEP-HC) | Temporal Equivalence Principle: EFT Mapping and CMB Acoustic Peak Preservation | [https://github.com/matthewsmawfield/TEP-HC](https://github.com/matthewsmawfield/TEP-HC) |
...
| **Paper 21** | [TEP-NIST](https://github.com/matthewsmawfield/TEP-NIST) | Local Temporal Topology and the Spatial Variation of Laboratory Gravitational Constants | [https://github.com/matthewsmawfield/TEP-NIST](https://github.com/matthewsmawfield/TEP-NIST) |
...
| **Paper 25** | [TEP-KIN](https://github.com/matthewsmawfield/TEP-KIN) | Temporal Equivalence Principle: Disformal Kinematics and the Measurement Landscape | [https://github.com/matthewsmawfield/TEP-KIN](https://github.com/matthewsmawfield/TEP-KIN) |
| **Paper 26** | [TEP-C0](https://github.com/matthewsmawfield/TEP-C0) | Temporal Equivalence Principle: A Covariant Alternative to Cosmic Expansion | [10.5281/zenodo.20370144](https://doi.org/10.5281/zenodo.20370144) |
