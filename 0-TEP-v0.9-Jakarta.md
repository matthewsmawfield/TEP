...
$$\gamma_{\rm PPN} - 1 = -2\alpha_{\rm eff}^2 \to 0, \qquad \beta_{\text{PPN}} - 1 = \frac{\alpha_{\rm eff}^2}{2} \frac{d\alpha_{\rm eff}}{d\phi} \to 0.$$
Thus $\gamma_{\rm PPN} = \beta_{\text{PPN}} = 1$ in the screened limit, independent of the cosmological value $\alpha_0$.
...
| $\gamma_{\rm PPN}$, $\beta_{\text{PPN}}$ | Eddington PPN parameters | 7 |
